...
<input type="hidden" id="vNames" value="${listNames}" />
<input type="hidden" id="vNums" value="${listNums}" />
<div id="chart"></div><br />
</body>
<script>
    var listNames;
    ...
    $(document).ready(function(){
        ...
        var vnames=$("#vNames").val();
        vnames=vnames.replace(/\[|]/g,'');
        listNames =vnames.split(",");
        var vNums=$("#vNums").val();
        vNums=vNums.replace(/\[|]/g,'');
        listNums=vNums.split(",");
        option = {
            tooltip : {
                trigger: 'axis',
