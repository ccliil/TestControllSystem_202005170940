...
<form action="/teacher/judge/list" method="post" class="form-inline" style="padding: 10px;">
...
<table class="table table-striped table-bordered table-hover" id="news-lis">
    ...
    <c:forEach items="${list}" var="judge">
        <tr>
            ...
            <td>
                <a href="/test/judge/update?jid=${judge.jid}">修改</a>&nbsp;&nbsp;
                <a href="/test/judge/delete?jid=${judge.jid}">删除</a>
            </td>
        </tr>
    </c:forEach>
</table>
