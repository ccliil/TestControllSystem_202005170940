...
<form action="/test/vacant/list" method="post" class="form-inline" style="padding: 10px;">
...
<table class="table table-striped table-bordered table-hover" id="news-lis">
    ...
    <c:forEach items="${list}" var="vacant">
        <tr>
            ...
            <td><a href="/test/vacant/update?vid=${vacant.vid}">修改</a>&nbsp;&nbsp;<a
                    href="/test/vacant/delete?vid=${vacant.vid}">删除</a></td>
        </tr>
    </c:forEach>
</table>
