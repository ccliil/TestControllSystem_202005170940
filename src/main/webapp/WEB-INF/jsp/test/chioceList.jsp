...
<form action="/test/chioce/list" method="post" class="form-inline" style="padding: 10px;">
...
<table class="table table-striped table-bordered table-hover" id="news-lis">
    ...
    <c:forEach items="${list}" var="chioce">
        <tr>
            ...
            <td>
                <a href="/test/chioce/update?cid=${chioce.cid}">修改</a>
                <a href="/test/chioce/delete?cid=${chioce.cid}">删除</a>
            </td>
        </tr>
    </c:forEach>
</table>
