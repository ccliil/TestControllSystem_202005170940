    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/teacher/chioce/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>选择题列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/chioce/add">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加选择题</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/judge/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>判断题列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/judge/add">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加判断题</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/vacant/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>填空题列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/vacant/add">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加填空题</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/teacher/addTest">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>创建试卷</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/testList">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>试卷列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="/teacher/testInfo/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>已考试卷列表</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/teacher/file/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文档查询</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="/teacher/file/add">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>上传文档</cite>
                        </a>
                    </li>
